...
window (close | clothes): user.vscode("workbench.action.closeWindow")
...
bar (source | git): user.vscode("workbench.view.scm")
...
get stage: user.vscode("git.stage")
git stage all: user.vscode("git.stageAll")
get stage all: user.vscode("git.stageAll")
